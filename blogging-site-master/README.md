...
3. We can add/make as many blogs you want.
4. We can add Headings, paragraphs, and Images to the blog post. 
5. Have read more blogs section also.

We can checkout it coding tutorial [here](https://youtu.be/AWHGQfzfHxI).
